...
def loadData2():
    ...
    label_symptoms = {
        ...
        1: {"required": ['migraine', 'noise_sensitivity', 'nausea_vomit'], "ignore":[]},
        2: {"required": ['migraine', 'noise_sensitivity'], "ignore":['nausea_vomit']},
        3: {"required": ['migraine', 'nausea_vomit'], "ignore":['noise_sensitivity']},
