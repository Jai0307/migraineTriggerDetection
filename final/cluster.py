...
symptoms_labels = [
    'left_side', 'right_side', 'middle', 'both_sides', 'around_eyes', 'back_of_neck', 'unilateral', 'throbbing_1', 'throbbing_2', 'tight_head', 'dull_heavy', 'worsen_move', 'food', 'nausea_vomit', 'throw_up', 'noise_sensitivity', 'smell', 'light', 'light_noise', 
]
# 'duration_min', 'intensity', 'intensity_index'
triggers = [
...
# 'age', 'bmi', 'tight_headache', 'throbbing2', 'dull_heavy_headache', 
    ...
    symptoms.insert(0, column='Cluster', value=km.labels_)
    symptoms.insert(0, column='ID', value=np.array(ids))
